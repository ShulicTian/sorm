			...
			<div id="topics" style="height:752px;width:99%;margin:auto;background-color:white;padding-top:45px;">
				...
				<div v-for="top in topics" class="topic" style="padding:0px 45px;">
					...
					<div id="readed">
						...
						<a href="javascript:void(0)" id="rem" @click="rem(top.id)" class="layui-btn layui-btn-normal layui-btn-sm" style="width:60px;"><i class="layui-icon" style="color:green"></i>删除</a>
					</div>
	...
	<script type="text/javascript">
		new Vue({
			...
			data:{
				...
				url: ${genre==0}?'zeroPage':${genre==1}?'onePage':${genre==2}?'towPage':''
			},
			methods:{
