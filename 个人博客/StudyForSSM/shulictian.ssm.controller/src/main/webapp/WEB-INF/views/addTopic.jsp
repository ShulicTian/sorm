...
#d1{
	width:60%;
	margin:0 auto;background-color:white;padding:20px;margin-top:20px;
}
#texts{width:90%;margin:0 auto;}
</style>
</head>
<body>
	<div style="background-color:#f5f6f7;">
		...
		<div id="d1">
			<form class="layui-form" action="addTop" id="send" method="post">
				<div class="layui-form-item">
					<div class="layui-input-block" style="margin-left:50px;width:100px;float:left;padding:10px 5px;">
					...
					<div class="layui-input-block" style="margin:0px;padding:10px 5px;width:900px;float:left;">
					      <input name="title" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input" type="text">
					</div>
				</div>   
				<div id="texts">
					<textarea rows="3" cols="3" name="text"></textarea><br>
				</div>
				...
				<div id="butt">
					...
					<input class="layui-btn layui-btn-primary" type="button" value="存入草稿" @click="draft">
					<input class="layui-btn layui-btn-primary" type="button" value="取消"  @click="cancel">
				</div>
			</form>
		</div>
	...
	<script type="text/javascript">
		new Vue({
			...
			methods:{
				...
				draft:function(){
					$("#send").attr("action","addDraft")
					console.log($("#send").attr("action"))
					$("#send").submit() 
				}
			}
		})
