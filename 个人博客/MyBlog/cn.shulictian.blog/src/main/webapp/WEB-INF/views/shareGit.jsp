...
<body>
	<div style="padding:30px;" id="content">
		<form class="layui-form" action="bigCow/other/upGit" method="post">
			...
			<div class="layui-collapse" lay-accordion="" lay-filter="pros">
				<div class="layui-colla-item add" style="display:none;">
				    ...
				    <div class="layui-colla-content">
					    <form class="layui-form pros" action="bigCow/other/addPro" method="post" style="margin-top:10px;">
					    	<div class="layui-form-item">
			  	...
			  	<div v-if="pros!=''&&pros!=null">
			  		<div class="layui-colla-item" id="pro" v-for="pro in pros">
					    ...
					    <div class="layui-colla-content ctx">
						    <form class="layui-form pros" action="bigCow/other/upPro" method="post" style="margin-top:10px;">
						    	<input type="hidden" name="id" v-bind:value="pro.id"/>
						    	<div class="layui-form-item">
									<label class="layui-form-label lab">项目名称</label>
									<div class="layui-input-inline" style="width:200px;">
										<input type="text" name="name" v-bind:value="pro.name" class="layui-input"/>
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label lab">项目简介</label>
									<div class="layui-input-inline" style="width:300px;">
										<textarea type="text" name="descs" v-bind:value="pro.descs" class="layui-textarea"></textarea>
									</div>
								</div>
								<div class="layui-form-item">
									<label class="layui-form-label lab">项目路径</label>
									<div class="layui-input-inline" style="width:350px;">
										<input type="text" name="address" v-bind:value="pro.address" class="layui-input"/>
									</div>
								</div>
