 ...
 * Generated at: 2018-03-15 05:25:37 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\t<div id=\"tit\"><a v-bind:href=\"'bigCow/topic/get/'+top.id\" target=\"_blank\"><h6>{{top.title}}</h6></a><br/></div>\r\n");
      out.write("\t\t\t\t\t<div id=\"time\"><span style=\"color:gray;\">{{top.sendTime | formatDate}}</span></div>\r\n");
      out.write("\t\t\t\t\t<div id=\"userName\"><a  v-bind:href=\"'bigCow/user/getUserCus/'+top.user.id\" target=\"_blank\">{{top.user.nickName}}</a></div>\r\n");
      out.write("\t\t\t\t\t<div id=\"text\">{{top.text | formatText}}</div>\r\n");
      out.write("\t\t\t\t\t<div style=\"clear:right;\"></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<a href=\"javascript:void(0)\" class=\"rem\" @mouseenter=\"rem(top.id)\" class=\"layui-btn layui-btn-normal layui-btn-sm\" style=\"width:60px;\"><i class=\"layui-icon\" style=\"color:green\"></i>删除</a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div style=\"clear: both;\"></div>\r\n");
      out.write("\t\t\t\t\t<hr style=\"margin:0px;\"/>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"setPaging\" style=\"text-align: center;\"></div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div style=\"clear:both;\"></div>\r\n");
      out.write("\t</div>\r\n");
