...
<body>
	<div style="padding:30px;" id="msgs">
		<form action="bigCow/user/upNickName" style="margin-top:30px;" method="post">
			<div class="layui-form-item">
				<label class="layui-form-label lab">昵称</label>
				<div class="layui-input-block" style="width:200px;">
					<input name="nickName" autocomplete="off" type="text" value="${sessionScope.user.nickName}" class="layui-input"/>
				</div>
			</div>
		</form>
		<form class="layui-form" action="bigCow/other/upMsg" method="post" lay-filter="formMsg">
